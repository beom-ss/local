...
#------------------------------------------------------------------------------#
  ...
  # confidence intervals for expected values and predicted values

  predict.lm(model1, new=data.frame(units =4), interval="confidence")
  predict.lm(model1, new=data.frame(units =4), interval="prediction")
